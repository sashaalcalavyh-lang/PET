...
# Comparando Admin Anterior (Costos 7.5M, Ticket 53k) vs Admin Nueva (Costos 3.0M, Ticket 42k)
fig1 = go.Figure()
fig1.add_trace(go.Bar(
    x=['Admin Anterior (Costos $7.5M)', 'Nueva Admin (Costos $3.0M)'],
    y=[140, 71], # 7500000 / 53754 ~= 140 pacientes vs 3000000 / 42000 ~= 71 pacientes
...
# Admin Nueva (Conservadora 110 pacientes): 110 * 42k = 4.6M Ingresos. Costos 3.0M. Utilidad Bruta 1.62M.
fig3 = go.Figure(data=[
    go.Bar(name='Ingresos', x=['Admin Anterior', 'Nueva Admin (Conservador)'], y=[8500000, 4620000], marker_color='#3b82f6'),
    go.Bar(name='Costos Fijos', x=['Admin Anterior', 'Nueva Admin (Conservador)'], y=[7500000, 3000000], marker_color='#ef4444'),
    go.Bar(name='Utilidad Neta (Aprox)', x=['Admin Anterior', 'Nueva Admin (Conservador)'], y=[1000000, 1620000], marker_color='#10b981')
])
# Change the bar mode
